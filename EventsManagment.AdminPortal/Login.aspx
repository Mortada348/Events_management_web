<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EventsManagment.AdminPortal.Login" %>
...
<html lang="en">
	...
	<head><base href="../../"/>
		...
		<meta property="og:title" content="Events Management" />
		<meta property="og:url" content="https://keenthemes.com/products/oswald-html-pro" />
		<meta property="og:site_name" content="Events Management" />
				...
				<div class="d-flex flex-column flex-lg-row-auto bg-primary w-xl-600px positon-xl-relative">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-5 p-lg-10 pt-lg-20">
							...
							<h1 class="d-none d-lg-block fw-bold text-white fs-2qx pb-5 pb-md-10">Welcome to Events Management Admin Portal</h1>
							<!--end::Title-->
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100"   >
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to Events Management</h1>
									<!--end::Title-->
